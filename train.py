...
def build_model(output_size, hidden_unit1, hidden_unit2, hidden_unit3, hidden_unit4):
    model = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.IMAGENET1K_V1)
    for param in model.paramters():
        param.requires_grad = False
        
    model.classifier = nn.Sequential(nn.Linear(1280, hidden_unit1),
                            nn.ReLU(),
                            nn.Dropout(p = 0.2),
...
def main():
    ...
    parser.add_argument('--hidden_units1', type=int, default=1024, help="First layer of Hidden units")
    parser.add_argument('--hidden_units2', type=int, default=512, help="Second layer of Hidden units")
    parser.add_argument('--hidden_units3', type=int, default=256, help="Third layer of Hidden units")
    parser.add_argument('--hidden_units4', type=int, default=128, help="Final layer of Hidden units")
    ...
    model = build_model(args.output_size, args.hidden_units1, args.hidden_units2, args.hidden_units3, args.hidden_units4)
